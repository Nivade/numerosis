...
| `tenancy.central_domains` | `[numerosis.domains.central]`, derived from `APP_URL` | set the array yourself, or override `numerosis.domains.central` | `verifyCentralDomains()` (narrowed) |
