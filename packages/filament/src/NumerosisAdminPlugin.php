...
class NumerosisAdminPlugin implements Plugin
{
    ...
    public function register(Panel $panel): void
    {
        ...
        $panel
            ...
            ->discoverResources(in: $this->path('Resources'), for: 'Nvade\\NumerosisFilament\\Admin\\Resources')
            ->discoverClusters(in: $this->path('Clusters'), for: 'Nvade\\NumerosisFilament\\Admin\\Clusters')
            ->discoverPages(in: $this->path('Pages'), for: 'Nvade\\NumerosisFilament\\Admin\\Pages')
            ->pages([
                Dashboard::class,
            ])
            ->discoverWidgets(in: $this->path('Widgets'), for: 'Nvade\\NumerosisFilament\\Admin\\Widgets')
