...
/**
 * What happened to one provisioning step. Recorded instead of inferred, so a
...
enum StepOutcome: string
{
    ...
    /**
     * The step declared contributions the provision does not carry, such as
     * billing steps on a tenant provisioned without billing. Recorded with the
     * missing contribution so the absence stays visible instead of silent.
     */
