 ...
 *
 * Thrown when the same SetupIntent is resolved twice, by a double-click or a
 * replayed return from the payment provider, which would otherwise charge the
 * customer a second time for the same domain.
 */
