...
class Login extends Controller
{
     ...
     *
     * Resolves the `home` route name and swaps its host with
     * `tenant_route()`, rather than generating a URL against a route
     * registered only inside the tenant group: this callback always runs on
     * the central domain, so any tenant-only route name is absent from the
     * route collection here and `route()` would throw.
     */
