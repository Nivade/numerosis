        ...
        <div @class([
            ...
            <div class="flex flex-col h-full w-full">
                    ...
                    <div class="flex-1">
                        ...
                        <div class="mt-4 flex items-baseline">
                            @unless($isFree)
                                ...
                                <span class="ml-1.5 text-sm font-medium text-zinc-500 dark:text-zinc-400">
                                    {{ $billingCycle->label() }}
                                </span>
                            @else
                                <span class="text-4xl font-black text-zinc-900 dark:text-white tracking-tight">
                ...
                <div class="space-y-4 grow">
                    <h4 class="font-bold text-[11px] text-zinc-400 dark:text-zinc-500 uppercase tracking-widest">
                        What's included:
                    </h4>
