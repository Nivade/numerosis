    ...
    <div class="relative flex p-1 bg-gray-100 dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 shadow-inner">
        <button
            ...
            @class([
                ...
                'bg-white dark:bg-gray-700 shadow-md text-blue-600 dark:text-blue-400' => ($billingCycle instanceof \Nvade\Numerosis\Enums\BillingCycle ? $billingCycle->value : $billingCycle) === \Nvade\Numerosis\Enums\BillingCycle::Monthly->value,
                'text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200' => ($billingCycle instanceof \Nvade\Numerosis\Enums\BillingCycle ? $billingCycle->value : $billingCycle) !== \Nvade\Numerosis\Enums\BillingCycle::Monthly->value,
            ])
        >
            Monthly
        </button>
        <button
            ...
            @class([
                'relative py-2.5 px-8 text-sm font-bold transition-all duration-300 rounded-lg z-10',
                'bg-white dark:bg-gray-700 shadow-md text-blue-600 dark:text-blue-400' => ($billingCycle instanceof \Nvade\Numerosis\Enums\BillingCycle ? $billingCycle->value : $billingCycle) === \Nvade\Numerosis\Enums\BillingCycle::Yearly->value,
                'text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200' => ($billingCycle instanceof \Nvade\Numerosis\Enums\BillingCycle ? $billingCycle->value : $billingCycle) !== \Nvade\Numerosis\Enums\BillingCycle::Yearly->value,
            ])
        >
            Yearly
            @if($maxSavings > 0)
