        ...
        @foreach ($steps as $index => $step)
            ...
            <div class="flex flex-col items-center relative z-10 group">
                <div @class([
                    ...
                    'bg-primary text-white scale-110 shadow-primary/20 ring-4 ring-primary/10' => $isActive,
                    'bg-success-icon text-white' => $isCompleted,
            ...
            @if (!$loop->last)
                <div class="mx-0 -mt-7 h-[2px] flex-1 bg-zinc-100 dark:bg-zinc-800 relative">
                    <div @class([
                        ...
                        'bg-success-icon w-full' => $isCompleted,
                        'bg-linear-to-r from-success-icon to-primary w-full' => $isActive && $isCompleted, // Not possible with this logic but for future
                        'w-0' => !$isCompleted,
                    ])></div>
                </div>
            @endif
