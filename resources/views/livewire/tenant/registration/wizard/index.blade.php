    ...
    <div class="min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 bg-zinc-50 dark:bg-zinc-950">
        <div class="max-w-4xl w-full space-y-12">
            ...
            <div class="text-center space-y-4">
                <div class="mx-auto h-16 w-16 rounded-xl bg-linear-to-tr from-blue-600 to-indigo-600 flex items-center justify-center mb-6 shadow-xl shadow-blue-500/20 rotate-3 hover:rotate-0 transition-transform duration-500">
            ...
            <!-- Registration Form -->
            <div class="bg-white dark:bg-zinc-900 rounded-xl shadow-2xl shadow-zinc-200/50 dark:shadow-none border border-zinc-200 dark:border-zinc-800 p-8 md:p-12 transition-all duration-500">
